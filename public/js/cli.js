...
function getPub(){
    ...
    .then(md5=>{
        ...
        Vue.createApp(showMd5).mount('#showMd5');
        if(md5 != MD5(sessionStorage.getItem('pub')))
            alert('The public-key has been replaced!');
    });
}
...
function submitKey(){
    fetch('/submitKey', {
        ...
        body: JSON.stringify({
            key: encrypt(document.getElementById('key').value),
